...
/**
 * 持久化cookie 移植自android-async-http PersistentCookieStore
 * 
 * @Title: PersistentCookieStore.java
 * @Description:
 * @author jiwei@breadtrip.com
 * @date 2015年6月9日 下午5:37:47
 * @version V1.0
 */
public class PersistentCookieStore implements CookieStore {
	private static final String LOG_TAG = "PersistentCookieStore";
	private static final String COOKIE_PREFS = "CookiePersistentFile";
